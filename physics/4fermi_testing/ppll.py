...
# This function returns the full e+e- -> q qbar cross section in SMEFT
def sigma_llqq_tot(sh,l,q1,q2,wc_eff):
    ...
    def sh_func(coefficient, sh):
        return coefficient * sh**3

    # Define a dictionary of the non-zero Dirac traces when integrating over the full phase space
    f_fully_integrated = {}
    f_fully_integrated['SSLL'] = f_fully_integrated['SSLR'] = f_fully_integrated['SSRL'] = f_fully_integrated['SSRR'] = lambda sh: sh_func(1/4, sh)
    f_fully_integrated['VVLL'] = f_fully_integrated['VVLR'] = f_fully_integrated['VVRL'] = f_fully_integrated['VVRR'] = lambda sh: sh_func(1/3, sh)
    f_fully_integrated['TTLR'] = f_fully_integrated['TTRL'] = lambda sh: sh_func(4/3, sh)
