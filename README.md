...
Whilst we eventually hope to incorporate the features as part of the main program, currently the best way to access the FCC-ee sensitivity estimates is to make a local copy of the 'flavio' directory found in this repository. The package can then be used in the same way as the unmodified flavio package. 
